...
public class SpaFallbackEndpointTests
{
    ...
    [Arguments("/api/production/parameters", 404, "Not Found")]
    [Arguments("/api/production/parameters/key", 404, "Not Found")]
    [Arguments("/api/production/releases/parameters", 404, "Not Found")]
    [Arguments("/api/production/releases/parameters/key", 404, "Not Found")]
