...
export const MSG = {
  ...
  PASSWORD_RESET_GENERATED: "Password reset link generated",
  PASSWORD_RESET_COPIED: "Password reset link copied",
  PASSWORD_RESET_COPY_FAILED: "Failed to copy password reset link",
