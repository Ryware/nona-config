...
#nullable restore
        ...
        public async Task<List<global::Nona.Migrator.Core.Generated.Models.AuditLogDto>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::Nona.Migrator.Core.Generated.Models.AuditLogDto>(requestInfo, global::Nona.Migrator.Core.Generated.Models.AuditLogDto.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
