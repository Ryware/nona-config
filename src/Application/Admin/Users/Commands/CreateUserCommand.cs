...
public record CreateUserRequest(string Username, string Password, string? Role, string? Scope);
public record CreateUserCommand(string Username, string Password, string? Role, string? Scope) : IRequest<CreateUserResult>;
